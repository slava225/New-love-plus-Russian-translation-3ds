...
SHA-256 архива `New_Love_Plus_RU_v0.1.0-beta_Luma3DS.rar`:

```text
b3253bfd3831d11973a86a1bf6566830c255f20d73fcbae8d8897e2bda634fc7
```

Контрольные суммы файлов внутри архива находятся в `SHA256SUMS.txt`. История изменений: [CHANGELOG.md](CHANGELOG.md).
