...
> [!IMPORTANT]
> **Возможное обновление — 7 сентября 2026 года**
>
> Если всё пройдёт по плану, в понедельник может выйти новая версия русского перевода **New Love Plus+**.
>
> Сейчас обновление находится на стадии подготовки и тестирования. Дата предварительная и может измениться.
